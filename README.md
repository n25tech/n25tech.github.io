...
* **[minuet](https://github.com/n25tech/minuet)**
  productivity app for to do list, pomodoros and white noise. It's a single page app built in vanilla js. I built in vanilla js to brush-up on my frontend skills without the assistance of a framework. You can view it [here](https://minuet.n25tech.com).
